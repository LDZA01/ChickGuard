      ...
      <div className="flex items-start gap-4">
        ...
        <div className="relative flex-shrink-0">
          ...
          <span className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-white ${
            vet.status === 'online' ? 'bg-green-500' :
                ...
                {modeOptions.map(opt => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 p-3 rounded-xl border-2 transition-all text-left ${
                      mode === opt.key ? 'border-primary-500 bg-primary-50' : 'border-gray-200 hover:border-gray-300'
                    }`}
                  >
            ...
            {filters.map((f, i) => (
              <button
                ...
                className={`text-xs px-3 py-1.5 rounded-full border transition-all ${
                  i === 0 ? 'bg-primary-500 text-white border-primary-500' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                }`}
              >
                {f}
              </button>
